...
Doge: {"": "Object;rId,pos,image,maxSpeed,lateralMoveSpeed,verticalMoveSpeed,rotation,rotationSpeed",
  update$1: function(context) {
    ...
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (t1 > t2 || t1 < 0) {
      t1 = this.lateralMoveSpeed;
      if (typeof t1 !== "number")
        throw t1.$negate();
      this.lateralMoveSpeed = -t1;
    }
    t1 = this.pos.y;
    ...
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (t1 > t2 || t1 < 0) {
      t1 = this.verticalMoveSpeed;
      if (typeof t1 !== "number")
        throw t1.$negate();
      this.verticalMoveSpeed = -t1;
    }
    t1 = this.pos;
    t2 = t1.x;
    t3 = this.lateralMoveSpeed;
    if (typeof t3 !== "number")
      throw H.iae(t3);
    t1.x = t2 + t3;
    t3 = this.pos;
  ...
  render$1: function(context) {
    ...
    if (typeof t2 !== "number")
      throw t2.$negate();
    t2 = -t2 / 2;
    context.drawImage(t1, t2, t2);
    context.closePath();
    context.restore();
  },
  calculateMoveSpeed$0: function() {
    var t1, t2;
    t1 = this.maxSpeed;
    t2 = 2 * t1;
    this.lateralMoveSpeed = C.C__Random.nextInt$1(t2);
    this.verticalMoveSpeed = C.C__Random.nextInt$1(t2);
    t2 = this.lateralMoveSpeed;
    if (typeof t2 !== "number")
      throw t2.$lt();
    if (t2 < t1)
      this.lateralMoveSpeed = t1 - t2;
    t2 = this.verticalMoveSpeed;
    if (typeof t2 !== "number")
      throw t2.$lt();
    if (t2 < t1)
      this.verticalMoveSpeed = t1 - t2;
  },
  ...
  static: {
Doge$: function(id, imageName, startPos) {
  var t1 = new S.Doge(0, null, null, 10, null, null, 0, 0);
  t1.Doge$3(id, imageName, startPos);
  return t1;
}}
...
Pound: {"": "Object;items",
  ...
  static: {
Pound$withDoges: function(howManyDoges) {
  var t1 = P.List_List(null, S.Doge);
  H.setRuntimeTypeInfo(t1, [S.Doge]);
  t1 = new A.Pound(t1);
  t1.Pound$withDoges$1(howManyDoges);
  return t1;
}}
...
function dart_precompiled($collectedClasses) {
  ...
  if (!"name" in BackgroundRenderer)
    BackgroundRenderer.name = "BackgroundRenderer";
  $desc = $collectedClasses.BackgroundRenderer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BackgroundRenderer.prototype = $desc;
  function Coord(x, y) {
    this.x = x;
    this.y = y;
  }
  ...
  function Doge(rId, pos, image, maxSpeed, lateralMoveSpeed, verticalMoveSpeed, rotation, rotationSpeed) {
    ...
    this.lateralMoveSpeed = lateralMoveSpeed;
    this.verticalMoveSpeed = verticalMoveSpeed;
    this.rotation = rotation;
    this.rotationSpeed = rotationSpeed;
  }
  Doge.builtin$cls = "Doge";
  if (!"name" in Doge)
    Doge.name = "Doge";
  $desc = $collectedClasses.Doge;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Doge.prototype = $desc;
  function DogeFactory(images) {
    this.images = images;
  }
  DogeFactory.builtin$cls = "DogeFactory";
  if (!"name" in DogeFactory)
    DogeFactory.name = "DogeFactory";
  $desc = $collectedClasses.DogeFactory;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DogeFactory.prototype = $desc;
  function ImageList(imageNames) {
    this.imageNames = imageNames;
  }
  ImageList.builtin$cls = "ImageList";
  if (!"name" in ImageList)
    ImageList.name = "ImageList";
  $desc = $collectedClasses.ImageList;
  if ($desc instanceof Array)
    $desc = $desc[1];
